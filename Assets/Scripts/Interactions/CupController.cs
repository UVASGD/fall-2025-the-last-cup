...
public class CupController : MonoBehaviour
{
    ...
    protected virtual void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && IsFull && !IsInCooldown && !IsOnZipline())
            TryDescoop();
    ...
    private bool IsOnZipline()
    {
        Zipline[] ziplines = FindObjectsByType<Zipline>(FindObjectsSortMode.None);
